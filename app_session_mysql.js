// this project uses mysql as a session storage
...
app.post('/auth/login', function(req, res){
	...
	if(uname === user.username && pwd === user.password){
		...
		req.session.save(function(){ //after saving it, it redirects to the welcome page
...
app.get('/auth/logout', function(req, res){
	...
	req.session.save(function(){ // this function gives time to enter database 
		res.redirect('/welcome');	
	});
});